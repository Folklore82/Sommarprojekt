...
public class Arrayer {
	...
	public static void main(String[] args) {
		...
		list.add("Vincent");
		list.add("Fabian");
		//Lägger Saga på index 2
		list.add(2, "Saga");
		
		
		
		//Försöker köra printList med null innehåll
		try {
			printList(null);
		}//Här fångar programmet upp felet
	...
	public static void printList(ArrayList<String> list) {
		//Jag vet inte riktigt varför den här if-satsen behövs. Programmet borde väl lösa detta med try/Catch ovan
		if(list == null){
